...
<body class="text-center">
    ...
    <!-- HEADER -->
    <header id="monster" class="row header acerca_de_header" style="background-image: url('<?php echo get_home_url(); ?>/wp-content/uploads/2019/05/BANNER-NOSOTROS.jpg');
">
...
<!--Text for main slider (desktop) -->
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <!-- Top Navigation Menu -->
            <div class="topnav">
              <a href="#home" class="active"> <img class="img-fluid logo_main" src="<?php echo get_site_url(); ?>
/wp-content/uploads/2019/05/LOGO-MEDITEK-BLANCO.svg" height="100%" width="100%"></a>
              <div id="myLinks">
