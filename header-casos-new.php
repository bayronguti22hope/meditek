...
<body class="text-center">
  ...
  <!-- HEADER -->
  <header id="monster" class="row header exito_casos_header " style="background-image: url('<?php echo get_home_url(); ?>/wp-content/uploads/2019/05/BANNER-CASOS-DE-EXITO.jpg');">
...
<!--Text for main slider (desktop) -->
        <div class="container">
          <div class="row main_text_desktop" data-aos="fade-right" data-aos-offset="200" data-aos-delay="10" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top-center">
            <div class="">
              <div class="exito_header_text" style="padding-left:16px">
                <h3>CASOS</h3>
                <h5>DE ÉXITO</h5>
