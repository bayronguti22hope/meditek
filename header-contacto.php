...
<body class="text-center">
  ...
  <!-- HEADER -->
  <header id="monster" class="row header contacto_header">
...
<!--Text for main slider (desktop) -->
        <div class="container">
          <div class="row main_text_desktop"  data-aos="fade-down" data-aos-offset="200" data-aos-delay="10" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="true" data-aos-anchor-placement="top-center">
            <div class="">
